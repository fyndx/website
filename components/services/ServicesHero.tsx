      ...
      <div className="absolute inset-0 bg-gradient-to-r from-blue-50 to-indigo-50 z-0">
        <div className="absolute inset-0 opacity-10">
          <svg width="100%" height="100%">
            ...
            <rect x="0" y="0" width="100%" height="100%" fill="url(#services-hero-pattern)" />
          </svg>
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Comprehensive React Native development solutions tailored to your business needs
            </p>
          </motion.div>
          ...
          >
            From custom app development to maintenance and support, we offer end-to-end React Native services to help
            you build exceptional mobile experiences that drive business growth.
          </motion.p>
        </div>
      </div>
    </section>
